<div class="flex flex-col gap-6">
    <div class=" flex flex-wrap -mx-3 mb-2 ">
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            ...
            <input
                class="appearance-none block w-full bg-white-200 text-gray-700 border border-black-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                wire:change="addDni($event.target.value)" id="dni" name="dni" type="number" maxlength="8"
...
@enderror -->
        ...
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            ...
            <input
                ...
                id="nombres" name="nombres" type="text" placeholder="" value="{{ $nombre }}" readonly>
            @error('nombres')
                <p class="text-red-500 text-xs italic">{{ $message }}</p>
            @enderror
        </div>
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            ...
            <input
                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                id="apellidos" name="apellidos" type="text" placeholder="" value="{{ $apellido }}" readonly>
            @error('apellidos')
                <p class="text-red-500 text-xs italic">{{ $message }}</p>
            @enderror
        </div>
    ...
    <div class="flex flex-wrap -mx-3 mb-2">
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            ...
            <input
                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                id="fecha_y_hora" name="fecha_y_hora" type="datetime-local" placeholder=""
        ...
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            ...
            <div class="relative">
                <input
                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    id="oficina" name="oficina" type="text" wire:model="nombreOficina"
        ...
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            ...
            <div class="relative">
                <input type="text" value="{{ $name_sede }}"
    ...
    <div class=" flex flex-wrap -mx-3 mb-2">
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            ...
            <input
                class="appearance-none capitalize block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                id="piso" type="text" value="{{ $piso }}" readonly>
        </div>
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            ...
            <input
                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                id="personero_id" type="text" value="{{ Auth::user()->name }}" readonly>
        </div>
    </div>
    <div class="flex flex-col">
        <button
            class="mb-4 mx-auto bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded {{ $isDni && $isOficina ? '' : 'disabled' }}"
            {{ $isDni && $isOficina ? '' : 'disabled' }}>
            GUARDAR
        </button>
    </div>
    @if (session('message'))
